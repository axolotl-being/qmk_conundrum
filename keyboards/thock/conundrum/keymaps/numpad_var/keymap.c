 ...
 */
[_GAMER] = LAYOUT_grid(
    LT(0,KC_1),  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
    ...
    LCTL_T(KC_4), KC_GRV, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
KC_TRNS, KC_F11, KC_F4, KC_F5, KC_F6, KC_UNDS, KC_LPRN, KC_DLR, KC_PERC, KC_CIRC, KC_LCBR, KC_DEL, 
